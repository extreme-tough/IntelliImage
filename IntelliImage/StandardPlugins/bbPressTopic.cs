...
{
    class bbPressTopic : IPlugin
    {
        IPluginHost myPluginHost = null;
        string myName = "bbPressTopic";
        string myDescription = "Grabbing images from the forum page of a bbPress based site";
        string myNullText = "Please enter the URL list here\nEg: http://singletrackworld.com/forum/\nhttp://kitezone.ca/forum/";
        string myCaption = "bbPress Topic URL";
