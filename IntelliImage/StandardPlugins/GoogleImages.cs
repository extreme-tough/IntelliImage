...
{
    class GoogleImages: IPlugin
    {
        IPluginHost myPluginHost = null;
        string myName = "GoogleImages";
        string myDescription = "Grabbing images from google images";
        string myNullText = "Please enter the keyword list here\nEg: NASA Images\nExotic Fruits";
        string myCaption = "Google Images";
